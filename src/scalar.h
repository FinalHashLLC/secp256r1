...
static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar_t *a, int offset, int count);

/** Access bits from a scalar. Not constant time. */
static unsigned int secp256k1_scalar_get_bits_var(const secp256k1_scalar_t *a, int offset, int count);
